...
public class CDWindow extends JFrame {
    ...
    private void defineCDBottomPanel() {
    ...
    private static JPanel createTextPanel(JLabel lab, JTextField textField) {
        ...
        JPanel cdTop = new JPanel();
        JPanel bottom = new JPanel();
        cdTop.setLayout(new FlowLayout(FlowLayout.LEFT, 5, 0));
        ...
        textPanel.add(cdTop, BorderLayout.NORTH);
    ...
    class ButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            try {
                RuleSet r = RuleSetFactory.getRuleSet(CDWindow.this);
                r.applyRules(CDWindow.this);
                String result = atist + n + title + price;
