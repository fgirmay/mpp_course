...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(LambdaLibrary.EMPLOYEE_COUNTS.apply(list, 'E', 100000));
        // Input are 'List<Employee> for employees, Integer for salary > 100000, for character' and out put is a integer
        ...
        System.out.println(LambdaLibrary.NAMES_IN_EMPLOYEES.apply(list, 'R', 85000));
