...
public class Main {
    ...
    public static void prob1() {
        ...
        System.out.println(LambdaLibrary.PROBLEM1.apply(list, 55000, 12000));
    ...
    public static void prob2() {
        ...
        //Input, List<Transaction>, int year,

        List<Transaction> list = TraderTransactTestData.getTransactions();
        System.out.println(LambdaLibrary.PROBLEM2.apply(list, 2011));
    }
    ...
    public static void prob3() {
        // Use this list
        List<Transaction> list = TraderTransactTestData.getTransactions();
        System.out.println(LambdaLibrary.PROBLEM3.apply(list, "Cambridge"));
